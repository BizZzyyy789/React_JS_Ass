                                ...
                                <div className="card recent-sales overflow-auto">
                                    <div className="card-body">
                                        <a href="#" class="btn btn-primary mt-3 float-end" data-bs-toggle="modal"
                                            data-bs-target="#addNewPaymentModal">+ New Loan</a>
                                            ...
                                            <div className="modal-dialog">
                                                <div className="modal-content">
                                                    <div className="modal-header">
                                                        <h5 className="modal-title" id="addNewPaymentModalLabel">Add New Loan</h5>
                                                    ...
                                                    <div className="modal-body">
                                                        <form>
                                                            ...
                                                            <div className="mb-3">
                                                                <label for="name" className="form-label">Loan Detail</label>
                                                                <input type="text" className="form-control" id="name" aria-describedby="nameHelp" />
                                                            </div>
                                                            <div className="mb-3">
                                                                <label for="amount" className="form-label">Next Payment Detail</label>
                                                                <input type="number" className="form-control" id="amount" aria-describedby="amountHelp" />
                                                            </div>
                                                            <div className="mb-3">
                                                                <label for="penalty" className="form-label">Status</label>
